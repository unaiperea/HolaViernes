...
<nav>
	<ul class="menu">
		<li>
			...
			<ul>
				<li><a href="ejemplos/basicos/parrafos.jsp">Parrafos y
						enlaces internos</a></li>
				<li><a href="ejemplos/basicos/block_inline.jsp">Block e
						inline</a></li>
		...
		<li>
			...
			<ul>
				...
				<li><a href="ejemplos/formularios/datos_personales.jsp">Datos
						Personales</a></li>
