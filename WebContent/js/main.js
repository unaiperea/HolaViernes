...
function init(){
	...
	*/
	...
	localStorage.setItem("12","pepe"); //Auque se cierre el navegador y se vuelva a iniciar se mantendr�n
	sessionStorage.setItem("s1","se pierde si cerramos el navegador")//Al ser de SESI�N se pierde si cerramos el Navegador
...
function obtener_ganador(){
	...
	//Declaramos variable para recoger todas las celdas de la p�gina
	...
	//a�adir_a_lista(num_aleatorio,celdas[]);
